 ...
 * @param graph{Object} - The full contents of the graph in JSON-LD
 * @param subject{Object} - The subject including its predicates and objects to create a nested version of
 * @returns {Object}
 */
function nestSubject(graph, subject) {
    ...
    recursiveFunction(graph, subject, subject);
}
...
export var JsonLdWithOCCollection = APICollection.extend({
    ...
    parse: function(response) {
        ...
        return orderedItems.map((subject) => {
            const id = subject["@id"];
